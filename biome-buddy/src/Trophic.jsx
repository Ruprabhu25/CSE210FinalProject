...
const grassPop = new Population(grass.speciesid, 1000, 0.2, 0.02)
...
const rabbitPop = new Population(rabbit.speciesid, 250, 0.12, 0.05)
...
const foxPop = new Population(fox.speciesid, 40, 0.06, 0.07)
...
const hawkPop = new Population(hawk.speciesid, 12, 0.03, 0.08)
