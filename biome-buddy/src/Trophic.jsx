...
class ProducerTrophic extends TrophicLevel {
    constructor() {
        ...
        const grassPop = new Population(grass.name, 1000, 0.2, 0.05, 3000)

        const blueberryBush = new Species('Blueberry Bush', 2, 0.08, 0)
        const blueberryPop = new Population(blueberryBush.name, 400, 0.15, 0.04, 1200)
        super(
            "Producers",
            {[grass.name]: grass,
...
class PrimaryConsumerTrophic extends TrophicLevel {
    constructor() {
        ...
        const rabbitPop = new Population(rabbit.name, 250, 0.12, 0.05, 800)

        const deer = new Species('Deer', 10, 3)
        const deerPop = new Population(deer.name, 80, 0.08, 0.04, 250)
...
class SecondaryConsumerTrophic extends TrophicLevel {2
    constructor() {
        ...
        const foxPop = new Population(fox.name, 40, 0.10, 0.08, 150)

        const frog = new Species('Frog', 30, 7)
        const frogPop = new Population(frog.name, 25, 0.06, 0.06, 100)
...
class TertiaryConsumerTrophic extends TrophicLevel {
    constructor() {
        ...
        const hawkPop = new Population(hawk.name, 12, 0.08, 0.07, 50)

        const bear = new Species('Bear', 60, 15)
        const bearPop = new Population(bear.name, 6, 0.04, 0.03, 30)
